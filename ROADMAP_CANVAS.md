...
|----|-------------|------|------------|----------------|
| WS-1 | **Stability & Refactor** | Solid baseline with tests and CI | ✔ Persist saved questions (file) <br> ✔ Unit test coverage ≥ 60 % <br> ✔ Golden query harness <br> ✔ Centralised patient-attribute semantics (program completer support) <br> ✔ Fix condition mapping for obesity and mental health queries | Q2 2024 |
...
- **Last updated:** 2025-05-14 # Completed Session 019 – Data-Quality Gaps feature
...
### 2025-05-15 – Condition mapping issue
